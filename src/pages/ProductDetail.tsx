  ...
  return (
    <main className="flex-1 max-w-5xl mx-auto w-full px-3 sm:px-4 py-4 sm:py-10">
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-abu-cream overflow-hidden flex flex-col md:flex-row relative">
        {/* Imagen del producto */}
        <div className="w-full md:w-1/2 bg-abu-cream/20 aspect-square md:aspect-auto relative">
          <img 
            src={figure.imageUrl} 
            alt={figure.name} 
        ...
        <div className="w-full md:w-1/2 p-5 sm:p-8 md:p-10 flex flex-col relative">
          ...
          <div className="text-gray-600 mb-6 sm:mb-8 flex-1 text-sm sm:text-base">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 mt-auto">
            ...
            <a 
              ...
              className="flex-1 bg-[#25D366] hover:bg-[#20b858] text-white font-bold py-3 sm:py-3.5 rounded-xl transition-all active:scale-[0.98] hover:shadow-md flex items-center justify-center gap-2 text-sm sm:text-base"
            >
