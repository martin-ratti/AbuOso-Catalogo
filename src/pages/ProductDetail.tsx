...
export function ProductDetail() {
  ...
  const message = `¡Hola! Vengo del catálogo. Me interesa la figura '${figure.name}' ($${formatPrice(figure.price)}). ¿Tienen stock?`;
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-abu-cream overflow-hidden flex flex-col md:flex-row relative">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col relative">
          ...
          <button 
            ...
            className="absolute top-6 right-6 p-2 text-gray-500 hover:text-abu-accent hover:bg-abu-light rounded-full transition-all active:scale-95"
          ...
          <p className="text-2xl font-bold text-abu-accent mb-6">${formatPrice(figure.price)}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-auto">
            <button 
              ...
              className="flex-1 bg-abu-light hover:bg-abu-cream text-abu-brown border border-abu-cream font-bold py-3 rounded-xl transition-all active:scale-95 hover:shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:active:scale-100 disabled:hover:shadow-none"
            >
            ...
            <a 
              ...
              className="flex-1 bg-[#25D366] hover:bg-[#20b858] text-white font-bold py-3 rounded-xl transition-all active:scale-95 hover:shadow-md flex items-center justify-center gap-2"
            >
