      ...
      <div className="p-2.5 sm:p-3 flex flex-col flex-1 gap-1.5">
        ...
        <div className="mt-auto pt-1.5 grid grid-cols-2 gap-1.5 sm:gap-2">
          ...
          <a 
            ...
            className="w-full bg-[#25D366] hover:bg-[#20b858] text-white font-semibold py-2 rounded-xl text-xs transition-all active:scale-95 hover:shadow-sm flex items-center justify-center gap-1"
          >
