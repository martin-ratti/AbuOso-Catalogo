        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
            <div className="p-4 flex items-center justify-between border-b border-gray-100">
              <h3 className="font-bold text-lg text-abu-brown">
            ...
            <div className="p-5 overflow-y-auto">
              ...
              <div className="flex flex-col gap-3">
                {effectiveOptions.map((opt, idx) => (
                  ...
                  >
                    {opt.imageUrl ? (
                      <img src={opt.imageUrl} alt={opt.name} className="w-12 h-12 rounded-xl object-cover bg-abu-cream/30" />
                    ) : (
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-100">
              ...
              >
                {actionModal === 'cart' ? (
                  <>Confirmar y Agregar <ShoppingCart size={18} /></>
                ) : (
                  <>Confirmar y Pedir</>
                )}
              </button>
