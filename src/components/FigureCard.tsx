      ...
      <div className="p-3 flex flex-col flex-1 gap-2">
        ...
        <div className="mt-2 grid grid-cols-2 gap-2">
          ...
          <button 
            ...
            className="w-full bg-abu-light hover:bg-abu-cream text-abu-brown border border-abu-cream font-medium py-1.5 rounded-lg text-xs transition-all active:scale-95 hover:shadow-sm flex items-center justify-center gap-1.5 disabled:opacity-50 disabled:active:scale-100 disabled:hover:shadow-none"
          ...
          <a 
            ...
            className="w-full bg-[#25D366] hover:bg-[#20b858] text-white font-medium py-1.5 rounded-lg text-xs transition-all active:scale-95 hover:shadow-sm flex items-center justify-center gap-1.5"
          >
